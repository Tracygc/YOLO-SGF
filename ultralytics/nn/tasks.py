...
from ultralytics.nn.modules.QIHNet import ShuffleNetV2, Conv_maxpool, ShuffleNetV2_k5, ShuffleNetV2_lite

# 导入slim-neck中的VOVSCSP和GSConv模块，
from .modules.Slimneck import VoVGSCSP, GSConv, VoVGSCSPC
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            c2 = ch[f[-1]]
        # shuffleNetV2
        elif m in {ShuffleNetV2, Conv_maxpool, ShuffleNetV2_k5, ShuffleNetV2_lite}:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if c2 not equal to number of classes (i.e. for Classify() output)
