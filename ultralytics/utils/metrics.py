...
# 原始iou
def bbox_iou_orin(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    """
...
# 还添加了Focus和Inner的思想，
def bbox_iou(box1, box2, x1y1x2y2=True, ratio=1.0, GIoU=False, DIoU=False, CIoU=False, EIoU=False, MPDIoU=False,
             Inner=False, Focal=False, alpha=1, gamma=0.5, eps=1e-7):
    if Inner:
        (x1, y1, w1, h1), (x2, y2, w2, h2) = box1.chunk(4, -1), box2.chunk(4, -1)
        w1_, h1_, w2_, h2_ = w1 / 2, h1 / 2, w2 / 2, h2 / 2
    ...
    if CIoU or DIoU or GIoU or EIoU or MPDIoU :
        ...
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)  # convex height
        if CIoU or DIoU or EIoU or MPDIoU :  # Distance or Complete IoU
